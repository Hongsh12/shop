				...
				<tr>
					<td><select name="search_condition">
							<option value="goods_id"
								<c:if test="${search_condition == 'goods_id'}">selected</c:if>>상품번호</option>
							<option value="goods_title"
								<c:if test="${search_condition =='goods_title'}">selected</c:if>>상품이름</option>
							<option value="goods_publisher"
								<c:if test="${search_condition =='goods_publisher'}">selected</c:if>>제조사</option>
					</select> <input type="text" size="30" name="search_value"
						value="${search_value}" /> 
						<input type="submit" value="조회" /></td>
				</tr>
				<tr>
					<td>조회한 기간:<input type="text" name="beginYear" size="4"
						value="${beginYear}" />년 <input type="text" name="beginMonth"
						size="4" value="${beginMonth}" />월 <input type="text"
						name="beginDay" size="4" value="${beginDay}" />일 &nbsp; ~ <input
						type="text" name="endYear" size="4" value="${endYear}" />년 <input
						type="text" name="endMonth" size="4" value="${endMonth}" />월 <input
						type="text" name="endDay" size="4" value="${endDay}" />일
					</td>
				</tr>
			</TBODY>
		</TABLE>
